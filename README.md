# hkm-plugin-dev-tools

> HKM Kernel plugin — provides **`dev.tooling`**.
...
```bash
composer require alfacode-team/hkm-plugin-dev-tools
# or, from a project:
hkm plugins add dev-tools
```

## Capability

Provides `dev.tooling`.
